...
public class GameManager3 : MonoBehaviour
{
	...
	public MyBlockController3 Current { get; set; }
	...
	[SerializeField] private List<MyBlockController3> listPrefabs;

	private List<MyBlockController3> _listHistory = new List<MyBlockController3>();
